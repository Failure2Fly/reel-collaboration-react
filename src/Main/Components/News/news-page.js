        ...
        <div className="container full-news-article">
            ...
            <div className="column">
                ...
                <div className="post-content">
                    ...
                    <div className="post-meta"><span className="timestamp"><i className="fa fa-clock-"></i>
                        6 mins ago</span><span className="comments"><i className="fa fa-comments"></i><a href="#/">39 comments</a></span></div>
                </div>
                </div>
            </div>
            {/* <!-- Hover Demo--> */}
            ...
            <div className="info">
                <h1>Article News Card</h1><span>Made with <i className='fa fa-heart animated infinite pulse'></i> by <a href='http://andy.design'>Andy Tran</a> | Designed by <a href='http://justinkwak.com'>JustinKwak</a></span>
            </div>
        </div>
    )
}